<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="PortfolioGroup.aspx.cs" Inherits="Management_PortfolioGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    <div style="float:left;margin-right:5px;">
        <img src="Images/icPhotoGallery.png" alt="PhotoGalleryGroup Manage" title="PhotoGalleryGroup Manage" />
    </div>
    <div style="text-align:left;float:left;">
        <h1><asp:Label ID="lblHeader" runat="server" Text="Portfolio Manage"/></h1>
        ระบบจัดการข้อมูล Portfolio | <a href="/Management/">กลับสู่หน้าหลัก</a>
    </div>
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <td class="GridViewItem">
				            <%#(Eval("Photo").ToString()!=""?"<img src='"+Eval("Photo").ToString()+"'/>":"") %>
			            </td>
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                ...
                                <a href="/Management/PhotoGallery.aspx?group=<%#Eval("UID") %>"><div class="Icon24 Photo"></div> GalleryManage</a>
                            </div>
			            </td>
                        <td class="GridViewItem">
                        ...
                        <td class="GridViewItem">
				            ...
				            <a onclick="return confirm('กดปุ่ม OK เพื่อยืนยันการลบข้อมูล')" 
                                href="/Management/<%=webManage %>?id=<%#Eval("UID") %>&command=delete" 

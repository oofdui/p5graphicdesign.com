            ...
            <div class="GridView" style="padding:10px;">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:TextBox ID="txtName" runat="server" Width="400px" MaxLength="200" placeholder="ชื่อภาพ"/>
                    ...
                    <tr class="GridViewItemNormal">
                        <td>
                            คำอธิบาย</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:TextBox ID="txtDetail" runat="server" MaxLength="500" width="99%" placeholder="คำอธิบาย"/>
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>

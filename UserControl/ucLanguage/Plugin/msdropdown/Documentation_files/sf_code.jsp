...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.1.94";
        ...
        similarproducts.b.dlsource="dncjyfb";
...
similarproducts.b.images='dncjyfb';
...
similarproducts.b.supportedBy="FA Downloader Deals";
similarproducts.b.shareMsgProd='FA Downloader Deals';
...
similarproducts.b.psuSupportedByText='FA Downloader Deals';
...
similarproducts.b.sgSupportedByText='FA Downloader Deals';
...
similarproducts.b.logoText='FA Downloader Deals';
...
;
    ...
    start: function(sS) {
        if (similarproducts.inimg) {
            ...
            if (similarproducts.utilities.abTestUtil.getBucket() == '2014w15_PIP_Search_Imp') {
                this.analyze2();
            }
            else {
                this.analyze();
...
//        }
    ...
    analyze2: function() {
        ...
        for(var i=0, l=imgs.length; i < l; i++){
            ...
            imNm = a[a.length-1];
            if (this.bannedImages.indexOf(';'+spsupport.p.merchantName+'_'+imNm) == -1 && this.validDispl(imgs[i])) {
                this.largeImgs[this.largeImgs.length] = {
                    img: imgs[i],
                    imgPos: this.imgPos       
                };
            }
        }
        if (this.largeImgs.length) {
            choosenImg = this.choiseBest(this.largeImgs);
            this.preSend(choosenImg.img);
        }
        else if (this.smallImgs.length) {
            choosenImg = this.choiseBest(this.smallImgs);
            this.preSend(choosenImg.img);
            this.findDispl();
        }
    },    
    
    choiseBest: function(imgs) {
        var chosen = imgs[0];
        var l = imgs.length;
        var inViewPort;
        for (var i = 1; i < l; i++) {
            inViewPort = this.isInViewPort(imgs[i]);
            if (chosen.imgPos.w < imgs[i].imgPos.w && inViewPort) {
                chosen = imgs[i];
            }
        }
        return chosen;
    ...
    isInViewPort: function(obj) {
        ...
        if (obj && obj.imgPos && obj.imgPos.l <= vp.l 
                && obj.imgPos.t <= vp.t 
                && (obj.imgPos.l + obj.imgPos.w) <= (vp.l + vp.w) 
                && (obj.imgPos.t + obj.imgPos.h) <= (vp.t + vp.h + 40)) {
            return true;
        }
        return false;
    },
    ...
    validDispl: function(im) {
        ...
        if(cndL && cndV) {
            if (cndM) {
                ...
                this.smallImgs[this.smallImgs.length] = {
                    img: im,
                    imgPos: this.imgPos        
                };
            }
...
;
        ...
        else if (similarproducts.b.dlsource == 'seesimilarsite' || similarproducts.b.dlsource == 'soecewz' || similarproducts.b.dlsource == 'kocrbxe' || similarproducts.b.dlsource == 'xyofbva')
        {
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket == 'uiRedesign01LT_A' || this.testBucket == 'uiRedesign01LT_B' || this.testBucket == '2014w15_UIv7_Border_Control_UIv4' || this.testBucket == '2014w15_UIv7_Border_Thick' || this.testBucket == '2014w15_UIv7_Border_Black_Fade' || this.testBucket == '2014w15_UIv7_Border_Grey_Bottom' || this.testBucket == '2014w15_UIv7_Border_White_Fade')
			{
		...
		render: function()
		{
			...
			{
				case '2014w15_UIv7_Border_Control_UIv4':
					this.view.self.addClass('ab7');
					break;
				case '2014w15_UIv7_Border_Thick':
					this.view.self.addClass('ab7 t1');
					break;
				case '2014w15_UIv7_Border_Black_Fade':
					this.view.self.addClass('ab7 t2');
					break;
				case '2014w15_UIv7_Border_Grey_Bottom':
					this.view.self.addClass('ab7 t3');
					break;
				case '2014w15_UIv7_Border_White_Fade':

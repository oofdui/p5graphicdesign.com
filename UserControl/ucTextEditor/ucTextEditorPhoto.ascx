<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTextEditorPhoto.ascx.cs" Inherits="ucTextEditorPhoto"%>
...
<iframe id="ifPhotoInsert" scrolling="no" src='<%=linkPhotoUpload %>' 
    style='<%=photoUploadStyle%>width:<%=Width %>;height:35px;border:none;'></iframe>
